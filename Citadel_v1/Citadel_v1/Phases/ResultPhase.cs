...
namespace Citadel_v1
{
    class ResultPhase : Phase
    {
        ...
        public ResultPhase(List<Player> players, Phase phase, Decks deck) : this(players, phase.Round, deck)
        {

        }

        public ResultPhase(List<Player> players, Round round, Decks deck) : base(players, deck)
        {
            Round = round;
            IsEnd = false;
        }
